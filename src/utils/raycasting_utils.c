...
/*   Updated: 2025/03/02 16:25:59 by ededemog         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	algo_dda(t_map_info *map_info)
{
	...
	while (map_info->hit == 0)
	{
		...
		if (map_info->map_p[X] < 0 || map_info->map_p[X] >= map_info->map_width / 10 ||
			map_info->map_p[Y] < 0 || map_info->map_p[Y] >= map_info->map_height / 10)
			break;
