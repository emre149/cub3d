...
/* Function prototypes for the new files */
void						clean_buff(int **buff);
void						add_img(t_map_info *map_info, int **buff,
								t_img *img);
void						test_single_texture(t_map_info *map_info,
								int texture_id);
...
void						xpm_to_img(t_map_info *map_info, t_img *img,
								char *tex);
...
int							read_map_file(t_map_info *map_info,
								char *file_path);
int							parse_config(t_map_info *map_info);
int							process_config_line(t_map_info *map_info,
								char *line, int *map_started);
int							process_texture_line(t_map_info *map_info,
								char *line);
int							process_color_line(t_map_info *map_info,
								char *line);
...
char						**duplicate_map_lines(char **map, int start,
								int end);
...
** Rendering
*/
void						draw_square(t_map_info *map_info, int x, int y,
								int color);
...
** Minimap
*/
void						draw_mini_map(t_map_info *data,
								t_map_info *map_info);
void						draw_line_minimap(t_map_info *data, t_point start,
								t_point end, int color);
void						draw_player_dir(t_map_info *data,
								t_map_info *map_info);
void						draw_player_dot(t_map_info *data, int player_x,
								int player_y);
